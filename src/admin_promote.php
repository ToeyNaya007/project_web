...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <main class="w-full flex-grow p-6">
            <h1 class="text-3xl text-black pb-6">โปรโมทสินค้า </h1>
            <section class="bg-white py-8">
                <div class="container mx-auto">
                    <div class="max-w-md mx-auto">

                        <form action="promote_process.php" method="post" class="space-y-4"
                            enctype="multipart/form-data">

                          
                            <div class="mb-4">
                                <label for="category" class="block text-gray-700">เลือกสินค้า:</label>
                                <select id="category" name="category" class="border rounded-md w-full py-2 px-3">
                                    <option value=""></option>

                                    <?php
                                    $sqlcategory = "SELECT goods_id , goods_name FROM goods";
                            ...
                            <div class="flex justify-center">
                                <button type="submit"
                                    class="bg-blue-700 text-white py-2 px-4 rounded-md hover:bg-blue-600">โปรโมทสินค้า</button>
