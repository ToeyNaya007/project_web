...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="admin_manageuser.php" class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
            ...
            <main class="w-full flex-grow p-6">
                ...
                <div class="w-full mt-12">
                    <p class="text-xl pb-3 flex items-center">
                        <i class="fas fa-list mr-3"></i> จัดการสินค้า
                    </p>
                    <div class="bg-white overflow-auto">
                        <table class="min-w-full bg-white">
                            <thead class="bg-gray-800 text-white">
                                <tr>
                                    <th class=" text-left py-3 px-4 uppercase font-semibold text-sm ">รหัสสินค้า</th>
                                    ...
                                    <th class=" text-left py-3 px-4 uppercase font-semibold text-sm">แบรนด์</th>
                            ...
                            <tbody class="text-gray-700">
                                ...
                                // Loop เรียกข้อมูลและแสดงในตาราง
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <td> <a href="admin_editgoods.php?goods_id=<?= $row["goods_id"]?>"
                                                class="bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-800">แก้ไข</a>
                                            <a href="delete_goods.php?goods_id=<?= $row["goods_id"]?>"
