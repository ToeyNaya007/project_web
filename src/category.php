    ...
    <section class="bg-white py-8">
        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
            ...
            if (!empty($category_id)) {
                ...
                $sql = "SELECT * FROM goods WHERE brand_id = $brand_id AND category_id = $category_id";
            } else {
                // ถ้า category_id เป็นค่าว่างให้ดึงทุกสินค้าของแบรนด์เท่านั้น
                $sql = "SELECT * FROM goods WHERE brand_id = $brand_id";
            }
            $goodsResult = $conn->query($sql);
