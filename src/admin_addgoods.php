            ...
            <section class="bg-white py-8">
                <div class="container mx-auto">
                    <div class="max-w-md mx-auto">
                        ...
                        <form action="addgoods_process.php" method="post" class="space-y-4"
                            ...
                            <div class="mb-4">
                                <label for="category" class="block text-gray-700">หมวดหมู่สินค้า:</label>
                            ...
                            <div class="mb-4">
                                <label for="brand" class="block text-gray-700">เลือกประเภท:</label>
                            ...
                            <div class="flex justify-center">
                                <button type="submit"
                                    class="bg-blue-700 text-white py-2 px-4 rounded-md hover:bg-blue-600">เพิ่มสินค้า</button>
