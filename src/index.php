            ...
            <nav id="store" class="w-full z-30 top-0 px-6 py-1">
                <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-2 py-3">
                    ...
                    <div class="flex items-center" id="store-nav-content">
                        ...
                        <input type="text" id="searchInput" name="search_term" placeholder="ค้นหา...">
                            <button class="pl-3 inline-block no-underline hover:text-black" href="Search.php">
                ...
                while ($category = $categoryResult->fetch_assoc()) {
                    ...
                    <div class="w-full p-6">
                        ...
                        <div class="flex flex-wrap -mx-4">
                            <?php
                            $goodsSql = "SELECT * FROM goods WHERE category_id = $category_id LIMIT 4";
